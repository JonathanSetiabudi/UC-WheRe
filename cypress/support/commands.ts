...
declare global {
  namespace Cypress {
    interface Chainable {
      ...
      dismiss(subject: string, options?: Partial<Cypress.TypeOptions>): Chainable
      visit(originalFn: CommandOriginalFn, url: string, options: Partial<VisitOptions>): Chainable
